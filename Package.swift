...
let package = Package(
    ...
    targets: [
        .target(name: "PiyakCore", path: "PiyakBank", exclude: [
            "App", "Views", "Watch", "Widget", "Assets.xcassets", "Info.plist", "PiyakBank.entitlements",
            "Services/NotificationScheduler.swift", "Services/WatchSync.swift",
            "PrivacyInfo.xcprivacy", "Shared/DesignTokens.swift"
        ], sources: ["Shared/AppConfig.swift", "Shared/EarningsCalculator.swift", "Shared/Economy.swift",
