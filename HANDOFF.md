...
**최신 심사 결과:** 사용자가 제공한 Apple 메시지(13:56)에서 Guideline 2.1 추가 정보 요청과 ‘심사를 통과하지 못함’을 확인했습니다. 실물 기기 영상과 목적/대상·사용법·외부 서비스·지역 차이·규제/콘텐츠 권한 설명을 요구합니다. [대응 초안과 촬영 순서](docs/APP_REVIEW_FOLLOWUP.md)를 준비했으며, iPhone 16 / iOS 26.6.1은 사용자 제공 정보입니다. 영상은 아직 없고 Apple 회신·재제출도 하지 않았습니다. 아래 심사 대기 중 기록은 최초 접수 시점의 상태입니다.
