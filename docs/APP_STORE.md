...
**최신 결과:** 사용자가 제공한 13:56 Apple 메시지는 **Guideline 2.1 - Information Needed - New App Submission**이며 제출은 해결되지 않은 문제 상태입니다. 실물 기기 시연 영상과 설명 6개 항목을 요청했습니다. [영문 답변 초안·촬영 가이드](APP_REVIEW_FOLLOWUP.md)를 준비했고, 영상 대기 중이며 회신·재제출은 하지 않았습니다. 아래의 심사 대기 중 확인은 01:56 최초 접수 당시 기록입니다.
...
- TestFlight 빌드와 iPhone/iPad/Watch 스크린샷 연결 완료. 1.0 (2)의 Guideline 2.1 추가 자료 요청 대응 중
